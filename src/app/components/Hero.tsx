...
const stack = ["Laravel", "Next.js", "React.js", "NodeJS", "NestJS", "OpenAI", "Stripe", "Jest"]
          ...
          <div className="pb-2 lg:pb-10">
            ...
            >
              ...
              <p className="text-base leading-7 text-zinc-600 dark:text-zinc-400">
                Focused on practical delivery for products across Vietnam, Japan, and Singapore using Laravel, Next.js, React.js, NodeJS, and NestJS.
              </p>
            </div>
